...
describe('TodoList.vue', () => {
  it('deletes all todo whe click the delete button', async () => {
  ...
  //   await wrapper.find("#app > div:nth-child(2) > label > button").trigger('click')
  //   expect(wrapper.find(".todo-list-items").find('li').exists()).toBe(false)
  })
});
